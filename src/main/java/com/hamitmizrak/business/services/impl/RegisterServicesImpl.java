...
public abstract class RegisterServicesImpl implements IRegisterServices<RegisterDto, RegisterEntity> {
    ...
    public String registerSpeedData(Long data) {
        ...
        if(data!=null){
            ...
            registerDto.setRegisterPassword(passwordEncoderBeanClass.getPasswordEncoderBeanMethod().encode("1234"));
    ...
    public String registerAllUSerDelete() {
        ...
        String information=objectServiceList().size()+" tane veri silindi";
    ...
    @Override
    @Transactional// Create,Update,Delete
    public RegisterDto objectServiceCreate(Long rolesId, RegisterDto registerDto) {
        ...
        if(registerDto!=null && iRoleRepository.findAll().size()!=0){
            ...
            // Masking Password
            registerEntity.setRegisterPassword(passwordEncoderBeanClass.getPasswordEncoderBeanMethod().encode(registerDto.getRegisterPassword()));
    ...
    @Override
    @Transactional// Create,Update,Delete
    public RegisterDto objectServiceUpdate(Long id, RegisterDto registerDto) {
    ...
    @Override
    @Transactional// Create,Update,Delete
    public RegisterDto objectServiceDelete(Long id) {
        RegisterDto registerFindDto=objectServiceFindById(id);
